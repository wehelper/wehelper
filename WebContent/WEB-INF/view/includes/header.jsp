	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			<a href="index.html"> <img
				src="${metronicUrl}/admin/layout/img/logo.png" alt="logo"
				class="logo-default" />
			</a>
			...
			<ul class="nav navbar-nav pull-right">
						...
						<li>
							<ul class="dropdown-menu-list scroller" style="height: 250px;">
								<li><a href="inbox.html?a=view"> <span class="photo">
											<img src="${metronicUrl}/admin/layout/img/avatar2.jpg" alt="" />
								...
								<li><a href="inbox.html?a=view"> <span class="photo">
											<img src="${metronicUrl}/admin/layout/img/avatar3.jpg" alt="" />
								...
								<li><a href="inbox.html?a=view"> <span class="photo">
											<img src="${metronicUrl}/admin/layout/img/avatar1.jpg" alt="" />
				...
				<li class="dropdown dropdown-user"><a href="#"
					...
					data-hover="dropdown" data-close-others="true"> <img alt=""
						class="img-circle"
						src="${metronicUrl}/admin/layout/img/avatar3_small.jpg" /> <span
