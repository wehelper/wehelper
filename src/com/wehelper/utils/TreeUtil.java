...
public class TreeUtil {
	...
	List<WhMenu> rootMenus;
	List<WhMenu> childMenus;
	List<WhMenuBtn> childBtns;
	
	public TreeUtil(List<WhMenu> rootMenus,List<WhMenu> childMenus){
		this.rootMenus = rootMenus;
		this.childMenus = childMenus;
	}  
	
	public TreeUtil(List<WhMenu> rootMenus,List<WhMenu> childMenus,List<WhMenuBtn> childBtns){
		this.rootMenus = rootMenus;
		this.childMenus = childMenus;
	 ...
	 * @return
	 */
	private TreeNode MenuToNode(WhMenu menu){
		if(menu == null){
			return null;
		}
	 ...
	 * @return
	 */
	private TreeNode BtnToNode(WhMenuBtn btn){
		if(btn == null){
			return null;
		}
		TreeNode node = new TreeNode();
